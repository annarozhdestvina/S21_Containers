...
TEST(Vector, T44ReverseIteratorOperatorMinusIterator) {
  ...
  s21::Array<Item, 4>::size_type s21_size =
...
TEST(Vector, T67ConstReverseIteratorOperatorCast) {
  ...
  const s21::Array<Item, 4> s21_vector{Item(11), Item(), Item(),
                                       Item(44, 'd', 0.44444)};
  // const std::vector<Item> vector { Item(11), Item(), Item(), Item(44, 'd',
  // 0.44444) };

  s21::Array<Item, 4>::reverse_iterator s21_start =
      static_cast<s21::Array<Item, 4>::reverse_iterator>(
          s21_source.rend() -
          2);  // should be able to do that? std does not compile that
  s21::Array<Item, 4>::const_reverse_iterator s21_stop =
      s21_source.rbegin() + 1;
...
// {
//     const s21::Array<Item, 4> s21_source1 { Item(11), Item(22, 'b'), Item(33,
//     'c', 0.3333), Item(44, 'd', 0.44444) }; const s21::Array<Item, 4>
//     s21_source2 { Item(11), Item(22, 'b'), Item(33, 'c', 0.3333), Item(44,
//     'd', 0.44444) }; const s21::Array<Item, 3> s21_source3 { Item(11),
//     Item(22, 'b'), Item(33, 'c', 0.3333) }; const s21::Array<Item, 3>
//     s21_source4 { Item(11), Item(22, 'b'), Item(33, 'c', 0.3333) }; const
//     s21::Array<Item, 2> s21_source5 { Item(11), Item(22, 'b'), }; const
//     s21::Array<Item, 2> s21_source6 { Item(11), Item(22, 'b'), }; const
//     s21::Vector<s21::Array<Item, 3>> s21_vector {
//         s21_source1,
//         s21_source2,
//         s21_source3,
//         s21_source4,
...
//     const std::array<Item, 4> source1 { Item(11), Item(22, 'b'), Item(33,
//     'c', 0.3333), Item(44, 'd', 0.44444) }; const std::array<Item, 4> source2
//     { Item(11), Item(22, 'b'), Item(33, 'c', 0.3333), Item(44, 'd', 0.44444)
//     }; const std::array<Item, 3> source3 { Item(11), Item(22, 'b'), Item(33,
//     'c', 0.3333) }; const std::array<Item, 3> source4 { Item(11), Item(22,
//     'b'), Item(33, 'c', 0.3333) }; const std::array<Item, 2> source5 {
//     Item(11), Item(22, 'b'), }; const std::array<Item, 2> source6 { Item(11),
//     Item(22, 'b'), }; const std::array<std::vector<Item>> vector {
//         source1,
//         source2,
//         source3,
//         source4,
...
// pointers EXPECT_EQ(s21_vector.begin()->Size(), vector.begin()->size());
// vector.begin()->size();
// }
