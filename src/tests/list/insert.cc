...
namespace {
    ...
    TEST(List, T4InsertPosCountValue) {
        s21::List<Item> s21_list = {Item(11), Item(22), Item(33), Item(44), Item(55), Item(66),};
        std::list<Item> list = {Item(11), Item(22), Item(33), Item(44), Item(55), Item(66),};
    ...
    TEST(List, T0InsertIterator) {
        s21::List<Item> s21_source = {Item(111), Item(222), Item(333), Item(444), Item(555), Item(666),};
        ...
        std::list<Item> source = {Item(111), Item(222), Item(333), Item(444), Item(555), Item(666),};
    ...
    TEST(List, T0InsertInitializer) {
        ...
        --s21_pos;
        --s21_pos;
        const auto s21_it = s21_list.Insert(s21_pos, {Item(111), Item(222), Item(333), Item(444), Item(555), Item(666),});

        std::list<Item> list = {Item(11), Item(22), Item(33), Item(44), Item(55), Item(66),};
        std::list<Item>::const_iterator pos = list.cend();
        --pos;
        --pos;
        const auto it = list.insert(pos, {Item(111), Item(222), Item(333), Item(444), Item(555), Item(666),});
