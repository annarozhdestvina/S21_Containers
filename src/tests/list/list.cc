...
TEST(OperatorEqual, T0Equal) {
  const s21::List<Item> s21_list1 = {Item(11), Item(22), Item(33), Item(44),
                                     Item(55)};
  const s21::List<Item> s21_list2 = {Item(11), Item(22), Item(33), Item(44),
                                     Item(55)};
...
TEST(OperatorEqual, T7NotEqual) {
  const s21::List<Item> s21_list1 = {Item(11), Item(22), Item(666), Item(44),
                                     Item(55)};
  const s21::List<Item> s21_list2 = {Item(11), Item(22), Item(33), Item(44),
                                     Item(55)};
...
TEST(RuleOf5, T0MoveConstructor) {
  s21::List<Item> s21_list1 = {Item(11), Item(22), Item(33), Item(44),
                               Item(55)};
...
//     EXPECT_TRUE(s21_ms > ms ? (s21_ms - ms < ms * 1e-16) : (ms - s21_ms < ms
//     * 1e-16));
// }
