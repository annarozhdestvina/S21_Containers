...
TEST(Map, T0InsertManyBack)
{
    ...
    s21_map.Insert_many(std::make_pair(666, Item(666)), std::make_pair(777, Item(777)) );
...
TEST(Map, T1InsertManyEmptyBack)
{
    ...
    s21::Vector<std::pair<s21::Map<int, Item>::iterator,bool>> s21_result = s21_map.Insert_many(std::make_pair(11, Item(11)),
    ...
    EXPECT_EQ(s21_map, s21_map_expected);
    //  EXPECT_EQ(s21_result, s21_map.end());
}
...
TEST(Map, T0InsertMany)
{
    ...
    s21_result_expected.Push_back(s21_map2.Insert(std::make_pair(666, Item(666))));
    s21_result_expected.Push_back(s21_map2.Insert(std::make_pair(777, Item(777))));
    ...
    EXPECT_EQ(s21_result, s21_result_expected);
}
