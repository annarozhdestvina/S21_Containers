...
TEST(MultiMap, T0ConstructorInitializer) {
  const s21::MultiMap<int, Item> s21_multimap{
      {10, Item(3, 'c', 0.3)}, {10, Item(10, 'c', 0.3)},
      {12, Item(3, 'c', 0.3)}, {13, Item(3, 'c', 0.3)},
      {3, Item(3, 'c', 0.3)},  {1, Item(1, 'a', 0.1)},
      {1, Item(1, 'a', 0.1)},  {1, Item(1, 'a', 0.1)},
      {1, Item(1, 'a', 0.1)},  {1, Item(1, 'a', 0.1)},
      {2, Item(2, 'b', 0.2)},  {2, Item(2, 'b', 0.2)},
      {2, Item(2, 'b', 0.2)},  {2, Item(2, 'b', 0.2)},
      {3, Item(3, 'c', 0.3)},  {3, Item(3, 'c', 0.3)},
  };
...
TEST(MultiMap, T1ConstructorInitializer) {
  s21::MultiMap<int, Item> s21_multimap{
      {3, Item(3, 'c', 0.3)}, {1, Item(1, 'a', 0.1)}, {2, Item(2, 'b', 0.2)},
      {3, Item(3, 'c', 0.3)}, {3, Item(3, 'c', 0.3)}, {4, Item(4, 'd', 0.4)},
      {5, Item(5, 'e', 0.5)}, {6, Item(6, 'f', 0.6)},
  };
  std::multimap<int, Item> multimap{
      {3, Item(3, 'c', 0.3)}, {1, Item(1, 'a', 0.1)}, {2, Item(2, 'b', 0.2)},
      {3, Item(3, 'c', 0.3)}, {3, Item(3, 'c', 0.3)}, {4, Item(4, 'd', 0.4)},
...
TEST(MultiMap, T0CopyConstructor) {
  const s21::MultiMap<int, Item> s21_source{
      {1, Item(1, 'a', 0.1)}, {6, Item(6, 'f', 0.6)}, {2, Item(2, 'b', 0.2)},
      {5, Item(5, 'e', 0.5)}, {2, Item(2, 'b', 0.2)}, {4, Item(4, 'd', 0.4)},
      {1, Item(1, 'a', 0.1)}, {2, Item(2, 'b', 0.2)}, {3, Item(3, 'c', 0.3)},
      {4, Item(4, 'd', 0.4)}, {4, Item(4, 'd', 0.4)}, {4, Item(4, 'd', 0.4)},
      {5, Item(5, 'e', 0.5)}, {6, Item(6, 'f', 0.6)},
  };
...
TEST(MultiMap, T0CopyAssignmentOperator) {
  const s21::MultiMap<int, Item> s21_source{
      {6, Item(6, 'f', 0.6)}, {5, Item(5, 'e', 0.5)}, {1, Item(1, 'a', 0.1)},
      {2, Item(2, 'b', 0.2)}, {1, Item(1, 'a', 0.1)}, {1, Item(1, 'a', 0.1)},
      {1, Item(1, 'a', 0.1)}, {1, Item(1, 'a', 0.1)}, {5, Item(5, 'e', 0.5)},
  };
  const std::multimap<int, Item> source{
      {6, Item(6, 'f', 0.6)}, {5, Item(5, 'e', 0.5)}, {1, Item(1, 'a', 0.1)},
      {2, Item(2, 'b', 0.2)}, {1, Item(1, 'a', 0.1)}, {1, Item(1, 'a', 0.1)},
...
TEST(MultiMap, T0MoveAssignmentOperator) {
  s21::MultiMap<int, Item> s21_source{
      {1, Item(1, 'a', 0.1111)}, {4, Item(4, 'd', 0.44)},
      {1, Item(1, 'a', 0.1)},    {1, Item(1, 'a', 0.11)},
      {1, Item(1, 'a', 0.111)},  {2, Item(2, 'b', 0.2)},
      {6, Item(6, 'f', 0.66)},   {3, Item(3, 'c', 0.3)},
      {3, Item(3, 'c', 0.33)},   {4, Item(4, 'd', 0.4)},
      {5, Item(5, 'e', 0.5)},    {6, Item(6, 'f', 0.6)},
  };
