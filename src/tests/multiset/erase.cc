...
TEST(MultiSet, T0EraseBegin) {
  ...
  s21::MultiSet<Item, ComparatorItem>::iterator s21_it_result =
      s21_multiset.Erase(s21_multiset.cbegin());
  std::multiset<Item, ComparatorItem>::iterator it_result =
      multiset.erase(multiset.cbegin());
...
TEST(MultiSet, T1EraseRBegin) {
  ...
  s21::MultiSet<Item, ComparatorItem>::const_iterator s21_it =
      s21_multiset.cbegin();
...
TEST(MultiSet, T5RandomErase)  // seems like std::multimap erases not the first
                               // element in the node
{
  // return;
  s21::MultiSet<Item, ComparatorItem> s21_multiset;
  ...
  // s21::MultiSet<Item, ComparatorItem>::iterator s21_it_result =
  // s21_multiset.Erase(s21_it); std::multiset<Item, ComparatorItem>::iterator
  // it_result = multiset.erase(it);
...
TEST(MultiSet, T0RandomExtract)  // TODO: enable it later
{
  ...
  s21::MultiSet<Item, ComparatorItem>::node_type s21_it_result =
      s21_multiset.Extract(s21_it);
  std::multiset<Item, ComparatorItem>::node_type it_result =
      multiset.extract(it);
...
TEST(MultiSet, T3RandomExtract) {
  ...
  // std::cout << s21_multiset << "\n\n";
  // s21::MultiSet<Item, ComparatorItem>::const_iterator s21_it =
  // s21_multiset.cbegin(); std::multiset<Item, ComparatorItem>::const_iterator
  // it = multiset.cbegin(); for (int i = 0; i < 4; ++i) {
  //     ++s21_it;
  //     ++it;
  // }

  s21::MultiSet<Item, ComparatorItem>::node_type s21_it_result =
      s21_multiset.Extract(s21_multiset.Find(Item(13)));
  std::multiset<Item, ComparatorItem>::node_type it_result =
      multiset.extract(multiset.find(Item(13)));
...
TEST(MultiSet, T4RandomExtract) {
  ...
  s21::MultiSet<Item, ComparatorItem>::node_type s21_it_result =
      s21_multiset.Extract(s21_multiset.Find(Item(99)));
  std::multiset<Item, ComparatorItem>::node_type it_result =
      multiset.extract(multiset.find(Item(99)));
