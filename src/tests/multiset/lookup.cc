...
TEST(Set, T1LowerBound) {
  ...
  EXPECT_EQ(*s21_multiset.Lower_bound(Item(15)),
            *multiset.lower_bound(Item(15)));
}
...
TEST(Set, T2LowerBound) {
  ...
  EXPECT_EQ(*s21_multiset.Lower_bound(Item(25)),
            *multiset.lower_bound(Item(25)));
}
...
TEST(Set, T3LowerBound) {
  ...
  EXPECT_EQ(*s21_multiset.Lower_bound(Item(35)),
            *multiset.lower_bound(Item(35)));
}
...
TEST(Set, T4LowerBound) {
  ...
  EXPECT_EQ(*s21_multiset.Lower_bound(Item(45)),
            *multiset.lower_bound(Item(45)));
}
...
TEST(Set, T5LowerBound) {
  ...
  EXPECT_EQ(*s21_multiset.Lower_bound(Item(55)),
            *multiset.lower_bound(Item(55)));
}
...
TEST(Set, T6LowerBound) {
  ...
  EXPECT_EQ(*s21_multiset.Lower_bound(Item(65)),
            *multiset.lower_bound(Item(65)));
}
...
TEST(Set, T7LowerBound) {
  ...
  EXPECT_EQ(*s21_multiset.Lower_bound(Item(75)),
            *multiset.lower_bound(Item(75)));
}
...
TEST(Set, T8LowerBound) {
  ...
  EXPECT_EQ(*s21_multiset.Lower_bound(Item(85)),
            *multiset.lower_bound(Item(85)));
}
...
TEST(Set, T11LowerBound) {
  ...
  EXPECT_EQ(*s21_multiset.Lower_bound(Item(10)),
            *multiset.lower_bound(Item(10)));
}
...
TEST(Set, T12LowerBound) {
  ...
  EXPECT_EQ(*s21_multiset.Lower_bound(Item(20)),
            *multiset.lower_bound(Item(20)));
}
...
TEST(Set, T13LowerBound) {
  ...
  EXPECT_EQ(*s21_multiset.Lower_bound(Item(30)),
            *multiset.lower_bound(Item(30)));
}
...
TEST(Set, T0UpperBound) {
  ...
  EXPECT_EQ(*s21_multiset.Upper_bound(Item(30)),
            *multiset.upper_bound(Item(30)));
}
...
TEST(Set, T1UpperBound) {
  ...
  EXPECT_EQ(*s21_multiset.Upper_bound(Item(25)),
            *multiset.upper_bound(Item(25)));
}
...
TEST(Set, T3UpperBound) {
  ...
  EXPECT_EQ(*s21_multiset.Upper_bound(Item(35)),
            *multiset.upper_bound(Item(35)));
}
...
TEST(Set, T4UpperBound) {
  ...
  EXPECT_EQ(*s21_multiset.Upper_bound(Item(45)),
            *multiset.upper_bound(Item(45)));
}
...
TEST(Set, T5UpperBound) {
  ...
  EXPECT_EQ(*s21_multiset.Upper_bound(Item(55)),
            *multiset.upper_bound(Item(55)));
}
...
TEST(Set, T6UpperBound) {
  ...
  EXPECT_EQ(*s21_multiset.Upper_bound(Item(65)),
            *multiset.upper_bound(Item(65)));
}
...
TEST(Set, T7UpperBound) {
  ...
  EXPECT_EQ(*s21_multiset.Upper_bound(Item(75)),
            *multiset.upper_bound(Item(75)));
}
...
TEST(Set, T8UpperBound) {
  ...
  EXPECT_EQ(*s21_multiset.Upper_bound(Item(85)),
            *multiset.upper_bound(Item(85)));
}
...
TEST(Set, T11UpperBound) {
  ...
  EXPECT_EQ(*s21_multiset.Upper_bound(Item(10)),
            *multiset.upper_bound(Item(10)));
}
...
TEST(Set, T12UpperBound) {
  ...
  EXPECT_EQ(*s21_multiset.Upper_bound(Item(20)),
            *multiset.upper_bound(Item(20)));
}
