...
TEST(Set, T0EraseBegin) {
  ...
  s21::Set<Item, ComparatorItem>::iterator s21_it_result =
      s21_set.Erase(s21_set.cbegin());
...
TEST(Set, T0RandomExtract)  // TODO: enable it later
{
  ...
  s21::Set<Item, ComparatorItem>::node_type s21_it_result =
      s21_set.Extract(s21_it);
