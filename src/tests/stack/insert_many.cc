...
TEST(Stack, T0InsertManyFront)
{
    ...
    s21::List<Item> s21_list2 { Item(11), Item(22), Item(33),  Item(777), Item(-33),};
...
TEST(Queue, T1InsertManyEmptyFront)
{
    ...
    s21_stack.Insert_many_front(Item(11), Item(22), Item(33), Item(44), Item(55), Item(66), Item(666), Item(777));
