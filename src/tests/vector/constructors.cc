...
{
    const s21::Vector<Item> s21_source { Item(11), Item(22, 'b'), Item(33, 'c', 0.3333) };
...
{
    const s21::Vector<Item> s21_source { Item(11), Item(22, 'b'), Item(33, 'c', 0.3333), Item(44, 'd', 0.44444) };
    s21::Vector<Item> s21_vector { Item(11), Item(22, 'b'), };
    s21_vector.Assign(s21_source.begin(), s21_source.end());

    const std::vector<Item> source { Item(11), Item(22, 'b'), Item(33, 'c', 0.3333), Item(44, 'd', 0.44444) };
    std::vector<Item> vector { Item(11), Item(22, 'b'), };
    vector.assign(source.begin(), source.end());
