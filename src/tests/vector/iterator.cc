...
TEST(Vector, T44ReverseIteratorOperatorMinusIterator)
{
    ...
    s21::Vector<Item>::size_type s21_size = s21_source.rend() - ++s21_source.rbegin();
...
TEST(Vector, T67ConstReverseIteratorOperatorCast)
{
    const s21::Vector<Item> s21_source { Item(11), Item(22, 'b'), Item(33, 'c', 0.3333), Item(44, 'd', 0.44444) };
    // const std::vector<Item> source { Item(11), Item(22, 'b'), Item(33, 'c', 0.3333), Item(44, 'd', 0.44444) };
    const s21::Vector<Item> s21_vector { Item(11), Item(), Item(), Item(44, 'd', 0.44444) };
    // const std::vector<Item> vector { Item(11), Item(), Item(), Item(44, 'd', 0.44444) };
    
 
    s21::Vector<Item>::reverse_iterator s21_start = static_cast<s21::Vector<Item>::reverse_iterator>(s21_source.rend() - 2);    // should be able to do that? std does not compile that 
    s21::Vector<Item>::const_reverse_iterator s21_stop = s21_source.rbegin() + 1;
    while (s21_start >= s21_stop) {
        *s21_start = Item();
        --s21_start;    
...
{
    const s21::Vector<Item> s21_source1 { Item(11), Item(22, 'b'), Item(33, 'c', 0.3333), Item(44, 'd', 0.44444) };
    const s21::Vector<Item> s21_source2 { Item(11), Item(22, 'b'), Item(33, 'c', 0.3333), Item(44, 'd', 0.44444) };
    const s21::Vector<Item> s21_source3 { Item(11), Item(22, 'b'), Item(33, 'c', 0.3333) };
    const s21::Vector<Item> s21_source4 { Item(11), Item(22, 'b'), Item(33, 'c', 0.3333) };
    const s21::Vector<Item> s21_source5 { Item(11), Item(22, 'b'), };
    const s21::Vector<Item> s21_source6 { Item(11), Item(22, 'b'), };
    ...
    const std::vector<Item> source1 { Item(11), Item(22, 'b'), Item(33, 'c', 0.3333), Item(44, 'd', 0.44444) };
    const std::vector<Item> source2 { Item(11), Item(22, 'b'), Item(33, 'c', 0.3333), Item(44, 'd', 0.44444) };
    const std::vector<Item> source3 { Item(11), Item(22, 'b'), Item(33, 'c', 0.3333) };
    const std::vector<Item> source4 { Item(11), Item(22, 'b'), Item(33, 'c', 0.3333) };
    const std::vector<Item> source5 { Item(11), Item(22, 'b'), };
    const std::vector<Item> source6 { Item(11), Item(22, 'b'), };
